/*
  ...
  ten minutes too early to an appointment, so you decided to take the opportunity to go for 
  a short walk. The city provides its citizens with a Walk Generating App on their phones 
  ...
  exactly ten minutes (you don't want to be early or late!) and will, of course, return you
...
function isValidWalk(walk) {
  ...
  for (const dir of walk) directions[dir]++;
