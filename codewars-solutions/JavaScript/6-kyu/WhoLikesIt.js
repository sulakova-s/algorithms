...
function likes(names) {
  ...
  if (len === 1) return `${names[0]} like${s} this`;
  if (len === 2) return `${names[0]} and ${names[1]} like${s} this`;
  if (len === 3)
    return `${names[0]}, ${names[1]} and ${names[2]} like${s} this`;

  return `${names[0]}, ${names[1]} and ${len - 2} others like${s} this`;
}

console.log(likes(undefined));                        // no one likes this
console.log(likes({}));                               // no one likes this
console.log(likes(""));                               // no one likes this
console.log(likes(1));                                // no one likes this
console.log(likes([]));                               // no one likes this
